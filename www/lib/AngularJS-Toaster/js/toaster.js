...
(function (window, document) {
    ...
    angular.module('toaster', []).constant(
        'toasterConfig', {
            ...
            'body-output-type': '', // Options: '', 'trustedHtml', 'template', 'templateWithData', 'directive', 'localDirective'
        ...
        /* takayuki tomita added. original directive */
        .directive('localScopeDirective', ['$compile', function($compile) {
            return {
                restrict: 'A',
                // scopeをfalseにすることで、directiveが呼び出された場所のscopeを利用する
                scope: false,
                link: function (scope, elm, attrs) {
                    scope.$watch('toaster.html', function (directiveName) {
                        var template = $compile('<div ' + directiveName + '></div>')(scope);
                        ...
                        '<div id="toast-container" ng-class="[config.position, config.animation]">' + 
                            '<div ng-repeat="toaster in toasters" class="toast" ng-class="toaster.type" ng-click="click(toaster)" ng-mouseover="stopTimer(toaster)" ng-mouseout="restartTimer(toaster)">' + 
                                ...
                                '<div ng-class="config.message" ng-switch on="toaster.bodyOutputType">' + 
                                    ...
                                    '<div ng-switch-when="localDirective"><div local-scope-directive>{{toaster.html}}</div></div>' + 
